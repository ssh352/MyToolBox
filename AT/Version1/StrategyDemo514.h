...
namespace AT
{
	...
	class StrategyDemo514 : public IStrategy
	{
	public:
		StrategyDemo514(const char* aConfigFile,AT::IDriver_TD * apTD  , AT::IStrategySpi* apStrSpi,const AT::IMarketCache* apMarket);
		virtual ~StrategyDemo514(void);
